...
import styles from './LiquidGlassStudio.module.scss';
import {
  createEmptyTexture,
  loadTextureFromURL,
  MultiPassRenderer,
  updateVideoTexture,
} from './rendering/GLUtils';
import type { IMultiPassRenderer, ITextureHandle } from './rendering/RendererInterface';
import {
  GPUMultiPassRenderer,
  gpuLoadTextureFromURL,
  gpuCreateEmptyTexture,
  gpuUpdateVideoTexture,
} from './rendering/GPUUtils';
import { detectWebGPU, type WebGPUDetectResult } from './rendering/gpuDetect';
import { ResizableWindow } from './controls/ResizableWindow';
import type { ResizeWindowCtrlRefType } from './controls/ResizableWindow/ResizableWindow';
...
import bgGrid from './assets/backgrounds/bg-grid.png';
import bgBars from './assets/backgrounds/bg-bars.png';
import bgHalf from './assets/backgrounds/bg-half.png';
import bgUI from './assets/backgrounds/bg-ui.svg';
import bgTahoeLightImg from './assets/backgrounds/bg-tahoe-light.webp';
import bgText from './assets/backgrounds/bg-text.jpg';
import bgBuildings from './assets/backgrounds/bg-buildings.png';
...
import { PresetControls } from './controls/PresetControls/PresetControls';

export type LiquidGlassStudioProps = {
  className?: string;
  style?: CSSProperties;
};

export function LiquidGlassStudio({ className, style }: LiquidGlassStudioProps = {}) {
        ...
        return (
          <div className={styles.bgSelect}>
            {[
              ...
              { v: 6, media: bgUI, loadTexture: true },
...
export default LiquidGlassStudio;
