 ...
 * through the displacement map â€?chroma at the edges, a moving specular
...
export const SWITCH_BASE: Partial<GlassOptics> = {
  ...
  // Resting puck drop-shadow (the floating white thumb sits ABOVE the track) â€?
...
export const GlassSwitch: React.FC<GlassSwitchProps> = ({
  ...
  const mv = useMemo(() => {
    ...
    // puck: 0.5px at rest, ramping to 0 as it blooms (tintOpacity 1â†?) and the glass
    // takes over. The slider needs none of this â€?it rides the <Glass> default 0.5.
  ...
  // inline style intentionally does NOT set it â€?a React re-render would
            ...
            <GlassDiv
              ...
              onPointerUp={(e) => {
                ...
                if (movedRef.current) {
                  ...
                  // input â€?onCheckedChange fires through handleChange.
