...
// Dark text â€?the bright frosted glass (lens brightness veil) is the material;
...
// dependencies â€?pass your own `wallpaper` (any CSS `background` value, e.g.
...
export const GlassNotification: React.FC<GlassNotificationProps> = ({
  title = "Priya Raman",
  time = "now",
  body = "Just landed â€?grabbing a cab. Save me a seat and order the usual?",
  avatar = "PR",
    ...
    >
      ...
      {ready && (
        <>
          ...
          />
          {/* Card content + the panel edge â€?crisp, on top of the glass. Same box
          ...
          <div
            style={{
              ...
              // light, not dark over a dark wallpaper) and gives it dimension â€?
