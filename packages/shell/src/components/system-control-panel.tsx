            ...
            <AnimatePresence>
              {feedback ? (
                <motion.div
                  ...
                  className="absolute top-0 left-1/2 z-30 -translate-x-1/2 whitespace-nowrap rounded-full border border-white/15 bg-black/55 px-3 py-1.5 text-[10px] font-medium shadow-xl backdrop-blur-xl"
