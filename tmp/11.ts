...
或：npx uilayouts@latest add mac-genie
...
Safari - Web browser with navigation and bookmarks
Arc - Modern browser with sidebar navigation
Trello - Project management board interface
Dribbble - Design showcase gallery
Command Code - Terminal/CLI interface
UI Layouts - Component library showcase
