...
def upgrade() -> None:
    ...
    op.create_index("ix_wallpaper_sources_organization_id", "wallpaper_sources", ["organization_id"])
    op.create_table(
        "wallpaper_assets",
        sa.Column("id", postgresql.UUID(as_uuid=True), nullable=False),
        sa.Column("organization_id", postgresql.UUID(as_uuid=True), nullable=False),
        ...
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint("organization_id", "provider", "external_id", name="uq_wallpaper_asset_org_external"),
    )
    op.create_index("ix_wallpaper_asset_org_owner", "wallpaper_assets", ["organization_id", "owner_user_id"])
    op.create_table(
        "wallpaper_favorites",
    ...
    op.create_index("ix_wallpaper_assignments_organization_id", "wallpaper_assignments", ["organization_id"])
    op.create_table(
    ...
    op.create_index("ix_wallpaper_ingest_jobs_organization_id", "wallpaper_ingest_jobs", ["organization_id"])
