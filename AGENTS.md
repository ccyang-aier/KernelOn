...
- 默认主 Web 栈为 Next.js App Router、React 19、TypeScript、Tailwind CSS 4、Zustand等。
...
所有前端代码开发应当主动遵循以下开发哲学，在开始任务请先打出：我已阅读前端开发哲学并知悉后续开发任务将按照该要求执行。
...
- 所有任务总是用简体中文回复，除非用户要求英文文案，文档中保留中文产品术语。
